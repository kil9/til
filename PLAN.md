...
페이지 3건 퍼블리시됨. 루트 갤러리는 `data-date` 최신순 정렬(T-10) + 이번달 외 카드 축약·연/월 아카이브(T-11) 적용, nuc14 에 일 1회 AI요약 잡 가동 중(T-12, cron 09:00 KST). 남은 태스크는 T-14(주제별 분류)·T-15\~T-17·T-19 이며(T-18 은 블록), 그 외에는 새 `/publish-pages` 요청이 오면 AGENTS.md 런북대로 페이지를 추가한다.
