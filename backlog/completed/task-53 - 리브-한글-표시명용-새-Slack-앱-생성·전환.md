...
후속(사용자 요청): 앱 아이콘 미설정 발견 → backlog/assets/liv/avatar-expression-curious.webp('살짝 흥미')를 512px PNG 로 변환해 App Icon 업로드. users.info image_512 커스텀 반영·#til 렌더링 확인.
<!-- SECTION:NOTES:END -->
