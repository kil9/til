...
- [x] #2 매 메시지 시스템프롬프트로 적용돼 리브 캐릭터(존댓말·저텐션·관리자님)로 응답함을 확인
<!-- AC:END -->
...
- 이식 내용: 정체성(리브·til 큐레이터), 성격(최소동선·저텐션·지식호더·담백 정정), 대화 문체(존댓말·관리자님 호칭·1-3문장·캐릭터성 드물게·이모지/느낌표 0·스레드 맥락), 아카이브 Q&A 규약(확인한 것만·추측 금지·URL 동반), 글쓰기 요청 경계(별도 잡 위임), 대화 예시 8종.
